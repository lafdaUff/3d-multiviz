...
import Mode3Video from "../../assets/mode3.webp";
    ...
    return (
        <>
            ...
            <div className="mode-selector">
                ...
                <button className={`mode-button ${currentMode === 'mode3' && 'selected'}`} onClick={() => setCurrentMode('mode3')} onMouseEnter={(e) => handleTooltip(e, 'Modo Bipartido', Mode3Video)} onMouseLeave={() => setTooltipContent(undefined)}><Mode3Icon className="mode-icon" /></button>
            </div>
